...
# nohup bash run.sh train RotatE FB15k 3 s0 1024 256 1000 24.0 1.0 0.0001 150000 16 -de --ss &
# nohup bash run.sh train RotatE FB15k-237 3 s0 1024 256 1000 9.0 1.0 0.00005 100000 16 -de --ss &
# nohup bash run.sh train RotatE wn18 3 s0 512 1024 500 12.0 0.5 0.0001 80000 8 -de --ss &
# nohup bash run.sh train RotatE wn18rr 3 s0 512 1024 500 6.0 0.5 0.00005 80000 8 -de --ss &
#
...
# nohup bash run.sh train ComplEx FB15k 1 s0 1024 256 1000 500.0 1.0 0.001 150000 16 -de -dr -r 0.000002 --ss &
# nohup bash run.sh train ComplEx FB15k-237 1 s0 1024 256 1000 200.0 1.0 0.001 100000 16 -de -dr -r 0.00001 --ss &
# nohup bash run.sh train ComplEx wn18 1 s0 512 1024 500 200.0 1.0 0.001 80000 8 -de -dr -r 0.00001 --ss &
# nohup bash run.sh train ComplEx wn18rr 1 s0 512 1024 500 200.0 1.0 0.002 80000 8 -de -dr -r 0.000005 --ss &
#
